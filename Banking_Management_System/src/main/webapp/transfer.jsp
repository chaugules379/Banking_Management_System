	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6 offset-md-3 border rounded mt-3 mb-5"
				...
				<form action="transferServlet" method="post" class="p-3">
					<input type="hidden" name="action" value="transfer"> <input
						type="hidden" name="accountId"
						value="<%=request.getParameter("accountId")%>">
					<div class="mb-3">
						<label for="targetAccountId" class="form-label">To Account ID</label> <input
							type="number" class="form-control" name="targetAccountId" required>
					</div>
					<div class="mb-3">
					...
					<div class="mb-3 text-center">
						<button type="submit" class="btn header1-bg w-50">Transfer</button>
					</div>
				</form>
			</div>
		</div>
